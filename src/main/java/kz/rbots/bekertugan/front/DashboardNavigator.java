    ...
    private void initViewChangeListener() {
        addViewChangeListener(new ViewChangeListener() {
            ...
            public void afterViewChange(final ViewChangeEvent event) {
                ...
                BotBoardEventBus.post(new BotBoardEvent.PostViewChangeEvent(view));
                BotBoardEventBus.post(new BotBoardEvent.BrowserResizeEvent());
                BotBoardEventBus.post(new BotBoardEvent.CloseOpenWindowsEvent());
