package kz.rbots.bekertugan.front.view.reports;
...
public final class ReportsView extends TabSheet implements View, TabSheet.CloseHandler,
    ...
    public void addReport(final ReportType reportType, final Object prefillData) {
        ...
        BotBoardEventBus.post(new BotBoardEvent.ReportsCountUpdatedEvent(
                getComponentCount() - 1));
        setSelectedTab(getComponentCount() - 1);
    }

    @Subscribe
    public void createTransactionReport(final BotBoardEvent.TransactionReportEvent event) {
